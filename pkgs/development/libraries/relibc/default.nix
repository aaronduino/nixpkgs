...
stdenvNoCC.mkDerivation {
  ...
  # pinned snapshot of https://static.redox-os.org/toolchain/x86_64-unknown-redox/relibc-install.tar.gz
  # src = buildPackages.fetchipfs {
  #   ipfs = "QmNp6fPTjPA6LnCYvW1UmbAHcPpU7tqZhstfSpSXMJCRwp";
  #   sha256 = "00khzxhr8857dr97z0j9wyybfz1kjr71xk457cfapfw5fjas4n00";
  # };
  src = fetchTarball {
